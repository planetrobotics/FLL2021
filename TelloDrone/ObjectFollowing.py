    ...
    for cnt in contours:
        ...
        if area > areaMin:
            ...
            if fbRange[0] < area < fbRange[1]:
                ...
                forwardBackward = -10
                cv2.putText(imgContour, " GO BACK ", (20, 80), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 3)
            elif fbRange[0] > area > 100:
                forwardBackward = 10
                cv2.putText(imgContour, " GO FORWARD ", (20, 80), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 3)
...
while True:
    ...
    drone.for_back_velocity = forwardBackward
